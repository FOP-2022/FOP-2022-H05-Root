    ...
    static {
        ...
        JAVADOC = DocumentationCriterion.forGrader(
            DocumentationGrader.builder()
                ...
                .addJavaDoc(d -> sharkCT.getConstructorDocumentation(d), H3_2)
                ...
                .addJavaDoc(d -> saltWaterCrocodileCT.getConstructorDocumentation(d), H3_3)
                .addJavaDoc(new MethodTester(sharkCT, "setAverageSpeed")::getMethodDocumentation, H3_3)
                .addJavaDoc(new MethodTester(sharkCT, "setAverageSpeed")::getMethodDocumentation, H3_3)
                .addJavaDoc(d -> saltWaterCrocodileAsAmphibeanCT.getConstructorDocumentation(d), H3_4)
